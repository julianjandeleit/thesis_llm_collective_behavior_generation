...
class MLPipeline:
    ...
    def train_dpo(self, model,tokenizer, lora_conf, dpo_dataframe, save_path, filter_nan_scores_bt=False):
        ...
        sft_conf["num_train_epochs"] = 0.1 # seems to round up though
        ...
        trainer = CustomDPOTrainer(learning_rate=5.0e-9,dataset = dpo_dataframe, model = sft_trained_B, lora = lora_conf, bnb=self.bnb_config, tokenizer=tokenizer)
